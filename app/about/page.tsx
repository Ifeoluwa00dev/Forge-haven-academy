...
export default function AboutPage() {
  return (
    <div className="pb-20">
      {/* Header banner */}
      <section className="border-b border-black/10 bg-forge-cream py-16 md:py-20">
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-forge-black/70">
      ...
      <section className="mx-auto max-w-4xl px-6 py-16">
        <p className="text-base leading-relaxed text-forge-black/80">
      ...
      <section className="mx-auto max-w-6xl px-6 pb-16">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          <div className="space-y-4 rounded-3xl border border-black/10 p-8 shadow-sm">
      ...
      <section className="mx-auto max-w-6xl px-6 pb-20">
        <div className="rounded-3xl border border-black/10 p-8 shadow-sm md:p-12">
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-forge-orange/10 text-forge-orange">
            <Target className="h-6 w-6" />
          </div>
          <h2 className="mt-4 text-2xl font-medium">Our vision</h2>
          <p className="mt-3 max-w-2xl text-sm text-forge-black/70">
